...
module Budgets
  class InvestmentsController < ApplicationController
    ...
    # muki added this
    before_action :authenticate_user!, except: [:index, :show, :json_data, :create]
    skip_authorization_check only: [:json_data, :create]
    ...
    private
      def investment_params
        params.require(:budget_investment)
              .permit(:title, :user_name, :user_address, :user_contact, :description, :q1, :q2, :q3, :q4, :q5, :heading_id, :tag_list, :price,
